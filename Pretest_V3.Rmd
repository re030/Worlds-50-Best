...
library("igraphdata")
# Read Edgelist
edges <- read.csv("https://raw.githubusercontent.com/re030/Worlds-50-Best/master/226305_Projekt_World_Edgelist.csv.csv", header=T, as.is=T, sep = ",") # liest die Edgelist ein
nodes <- read.csv("https://raw.githubusercontent.com/re030/Worlds-50-Best/master/226305_Projekt_World_Nodelist.csv.csv", header=T, as.is=T, sep=",") #liest die Nodelist ein
